...
QUAKE_SOUNDS = {
    ...
    [10] = {"killingspree.mp3", "KILLING SPREE (x5)",   "on a "},
    [11] = {"rampage.mp3",      "RAMPAGE (x10)",        "on a "},
    [12] = {"dominating.mp3",   "DOMINATING (x15)"},
    [13] = {"unstoppable.mp3",  "UNSTOPPABLE (x20)"},
    [14] = {"godlike.mp3",      "GODLIKE (x25)"}
}